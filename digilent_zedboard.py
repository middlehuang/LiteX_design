...
from litex.soc.integration.soc import SoCRegion, LiteXSoC
from litex.soc.integration.builder import *
from litex.soc.cores.freqmeter import FreqMeter
from litex.soc.cores.led import LedChaser
from litex.soc.cores.oled.oled import OledDisplay
from litex.soc.cores.oled.led import Led_switch

# LiteX IPs
sys.path.append("/home/james/litex/litedram/")
from litedram.core.crossbar import LiteDRAMCrossbar
from litedram.modules import MT48LC16M16
from litedram.phy import a7ddrphy
sys.path.append("/home/james/litex/litevideo/")
...
class BaseSoC(SoCCore):
    ...
    def __init__(self, platform, sys_clk_freq=int(100e6), 
                 with_oled_display=False, 
                 with_led_chaser=False,
                 with_led_switch=True,
                 **kwargs):
        ...
        # Oled display ------------------------------------------------------------------        
        if with_oled_display:
            self.submodules.oled = OledDisplay(
                pads         = platform.request("zed_oled"),
                ctrlpads     = platform.request("user_btn"),
                led          = platform.request("user_led"),
                platform     = platform,
                sys_clk_freq = platform.request("clk100"))
        
        if with_led_switch:
            self.submodules.led_sw = Led_switch(
                pads         = platform.request_all("user_led"),
                ctrl         = platform.request_all("user_sw"),
                platform     = platform,
                sys_clk_freq = platform.request("clk100"))
